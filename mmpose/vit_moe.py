...
# Vendored from ViTAE-Transformer/ViTPose (ViTMoE backbone for ViTPose++).
# BaseBackbone uses mmcv.runner.load_checkpoint (not mmcv_custom).
...
from timm_compat import drop_path, to_2tuple, trunc_normal_
...
class BaseBackbone(nn.Module, metaclass=ABCMeta):
    """Minimal backbone base (OpenMMLab-compatible) without mmcv_custom."""
